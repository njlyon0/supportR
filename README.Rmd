...
The two `..._chk` functions check a column in a dataframe to see what values would be coerced into NA if `as.numeric()` or `as.Date()` were called (see the prefix of these functions for which is which).
